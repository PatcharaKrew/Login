...
class AppAssets {
  static String kLogoBlue = 'assets/doorhub/logo_blue.png';
  static String kGoogle = 'assets/doorhub/google.svg';
  static String kFacebook = 'assets/doorhub/facebook.svg';
  static String kApple = 'assets/doorhub/apple.svg';
}

class DoorHubSignUp extends StatefulWidget {
  const DoorHubSignUp({Key? key}) : super(key: key);

  @override
  State<DoorHubSignUp> createState() => _DoorHubSignUpState();
}

class _DoorHubSignUpState extends State<DoorHubSignUp> {
